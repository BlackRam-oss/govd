...
const messages: Messages = {
  ...
  ErrorInstagramStoriesUnsupported: {
    en: 'instagram stories cannot be downloaded by this bot',
    it: 'le storie instagram non possono essere scaricate da questo bot',
    de: 'instagram-stories können von diesem bot nicht heruntergeladen werden',
    es: 'este bot no puede descargar las historias de instagram',
    fr: 'les stories instagram ne peuvent pas être téléchargées par ce bot',
    pt: 'as histórias do instagram não podem ser baixadas por este bot',
    ru: 'истории instagram не могут быть загружены этим ботом',
    zh: '此机器人无法下载 instagram 限时动态',
    ar: 'لا يمكن لهذا البوت تنزيل قصص انستغرام',
    ja: 'このボットではinstagramのストーリーをダウンロードできません',
    ko: '이 봇으로는 인스타그램 스토리를 다운로드할 수 없습니다',
  },
  ErrorUnavailable: {
    en: 'this content is not available or private',
    it: 'questo contenuto non è più disponibile o è privato',
    de: 'dieser inhalt ist nicht mehr verfügbar oder privat',
    es: 'este contenido ya no está disponible o es privado',
    fr: 'ce contenu n\'est plus disponible ou est privé',
    pt: 'este conteúdo não está mais disponível ou é privado',
    ru: 'этот контент больше недоступен или является приватным',
    zh: '该内容不可用或为私密内容',
    ar: 'هذا المحتوى غير متاح أو خاص',
    ja: 'このコンテンツは利用できないか、非公開です',
    ko: '이 콘텐츠는 사용할 수 없거나 비공개입니다',
  },
  ErrorTimeout: {
  ...
  ErrorGeoRestrictedContent: {
    ...
    it: 'questo contenuto non è disponibile nella tua regione',
    de: 'dieser inhalt ist in deiner region nicht verfügbar',
    es: 'este contenido no está disponible en tu región',
    fr: 'ce contenu n\'est pas disponible dans ta région',
    pt: 'este conteúdo não está disponível na sua região',
    ru: 'этот контент недоступен в вашем регионе',
    zh: '该内容在你的地区不可用',
    ar: 'هذا المحتوى غير متاح في منطقتك',
    ja: 'このコンテンツはお住まいの地域では利用できません',
    ko: '이 콘텐츠는 해당 지역에서 이용할 수 없습니다',
  },
  ErrorNSFWNotAllowed: {
  ...
  ErrorAltSitesPrefix: {
    en: 'you can use one of the following sites:',
    it: 'puoi usare uno dei seguenti siti:',
    de: 'du kannst eine der folgenden seiten verwenden:',
    es: 'puedes usar uno de los siguientes sitios:',
    fr: 'vous pouvez utiliser l\'un des sites suivants :',
    pt: 'você pode usar um dos seguintes sites:',
    ru: 'вы можете воспользоваться одним из следующих сайтов:',
    zh: '你可以使用以下网站之一：',
    ar: 'يمكنك استخدام أحد المواقع التالية:',
    ja: '以下のサイトのいずれかをお使いください：',
    ko: '다음 사이트 중 하나를 이용해 보세요:',
  },
