...
import { Media, MediaItem, MediaFormat, DownloadedFormat, Extractor } from '../models/index.js';
import { getMessageFileId, getMessageFileSize } from '../util/index.js';
import logger from '../logger/index.js';
import type { Message } from 'grammy/types';
import type { MediaRow } from '../database/index.js';
...
export function parseStoredMedia(extractor: Extractor, mediaRow: MediaRow): Media {
