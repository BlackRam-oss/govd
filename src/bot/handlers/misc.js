...
export async function closeHandler(ctx) {
...
export async function statsCallbackHandler(ctx) {
  return statsHandler(ctx);
}

export async function decodeErrorHandler(ctx) {
...
export async function whitelistHandler(ctx) {
...
export async function addedToGroupHandler(ctx) {
...
export async function oldMessagesHandler(ctx) {
  // ignore old messages
}
